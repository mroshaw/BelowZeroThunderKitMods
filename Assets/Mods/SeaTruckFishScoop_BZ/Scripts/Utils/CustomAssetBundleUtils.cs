...
namespace DaftAppleGames.SeaTruckFishScoop_BZ
{
    ...
    internal static class CustomAssetBundleUtils
    {
        ...
        /// </summary>
        internal static Sprite GetSpriteFromTexture(Texture2D texture)
        {
        ...
        {
            Log.LogDebug($"ModUtils: Looking for GameObject named {objectName} in Asset Bundle.");
            ...
            Log.LogDebug($"ModUtils: Found GameObject named {objectName} in Asset Bundle.");
            return obj;
        }
        ...
        public static GameObject GetPrefabInstanceFromAssetBundle(string objectName, bool activeState)
        {
            ...
            if (obj == null)
            {
                Log.LogDebug($"ModUtils: Couldn't find Prefab named {objectName} in Asset Bundle.");
                return null;
            }
            Log.LogDebug($"ModUtils: Found Prefab named {objectName} in Asset Bundle.");
