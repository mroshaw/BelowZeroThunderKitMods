...
namespace DaftAppleGames.SeaTruckRecall_BZ.DockRecaller
{
    ...
    /// </summary>
    internal class RecallConsoleInput : uGUI_InputGroup, IEventSystemHandler, uGUI_IButtonReceiver, IPointerHoverHandler
    {
        private const string HoverTextKey = "Recall Console";
