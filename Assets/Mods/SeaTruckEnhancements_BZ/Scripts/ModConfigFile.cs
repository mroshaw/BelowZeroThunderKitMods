...
namespace DaftAppleGames.SeaTruckEnhancements_BZ
{
    ...
    /// </summary>
    [Menu("SeaTruck Enhancements")] internal class ModConfigFile : ConfigFile
    {
        /// <summary>
        /// Speedometer
        /// </summary>
        [Toggle("Enable Speedomoeter", Tooltip = "Enables the onscreen Seatruck speedometer"),
         OnChange(nameof(OnSpeedometerChanged))]
        public bool EnableSpeedometer = true;

        /// <summary>
        /// Reversing Camera
        /// </summary>
        [Toggle("Enable Reversing Cam", Tooltip = "Enables the Seatruck reversing camera"),
         OnChange(nameof(OnReversingCamChanged))]
        public bool EnableReversingCamera = true;

        /// <summary>
        /// Reversing Audio
        /// </summary>
        [Choice("Reversing Audio", "None", "Beeps", "This SeaTruck is reversing", "Both",
            Tooltip = "Set the audio that will play when the Seatruck is reversing.")]
        ...
        [Slider(
            "Reversing Audio Volume",
            Tooltip = "Sets the volume of the Seatruck reversing audio.",
            Step = 0.05f,
            Format = "{0:F2}",
            Min = 0.0f,
            Max = 1.0f,
