# Seatruck Enhancements BZ

This mod adds some super-cool enhancements to the Seatruck!

## Features

- Adds a speedometer to the in-game UI.
- Adds a reversing camera, so you can back up the Seatruck safely.
- Adds a configurable reversing sound, so ocean inhabitants can get out of the way!
