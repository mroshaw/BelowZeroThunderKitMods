            ...
            internal static void Register(GameObject dnaModelGameObject)
            {
                Info = RegisterDnaPrefab(ClassId, null, null, TextureAssetName, Color.grey,
                    new LootDistributionData.BiomeData[]
                    {
                        ...
                        new LootDistributionData.BiomeData { biome = BiomeType.LilyPads_Crevice_SeamonkeyNest1, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.LilyPads_Crevice_SeamonkeyNest2, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.LilyPads_Crevice_SeamonkeyNest3, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.LilyPads_Crevice_SeamonkeyNest4, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.LilyPads_Crevice_SeamonkeyNest5, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.ArcticKelp_SeamonkeyNest1, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.ArcticKelp_SeamonkeyNest2, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.ArcticKelp_SeamonkeyNest3, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.ArcticKelp_SeamonkeyNest4, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
                        new LootDistributionData.BiomeData { biome = BiomeType.ArcticKelp_SeamonkeyNest5, count = SeaMonkeyFindCount, probability = SeaMonkeyFindProbability},
