...
{
    [HarmonyPatch(typeof(LandCreatureGravity))] internal class LandCreatureGravityPatches
    {
        /// <summary>
        ...
        {
            if (!__instance.bodyCollider) __instance.bodyCollider = __instance.GetComponentInChildren<SphereCollider>();
            return true;
        }
