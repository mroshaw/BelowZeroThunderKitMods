...
namespace DaftAppleGames.SubnauticaPets.Pets
{
    ...
    internal class SimpleMovement : MonoBehaviour
    {
        ...
        private const float GroundProbeDistance = 0.35f;
        ...
        private bool HasValidFloor(Vector3 position)
        {
            ...
            if (Vector3.Angle(closestNormal, Vector3.up) > _charController.slopeLimit) return false;
            return BelongsToPetBase(closestCollider);
        }
